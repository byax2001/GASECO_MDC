...
public class ReporteVentasService {
    ...
    public List<Map<String, Object>> VentasMoleculas(String Company, String FhInicial, String FhFinal) {
        String username = AppConstants.EPICOR_USER;
        String password = AppConstants.EPICOR_PASS;
        ...
        String baq_consult = "/api/v1/BaqSvc/AnaliticoRMol("+Company+")/Data?FhInicial="+FhInicial+"&FhFinal="+FhFinal;
        
        if(Company.equals("165943B") ){
            baq_consult = "/api/v1/BaqSvc/AnaliticoRMolHN("+Company+")/Data?FhInicial="+FhInicial+"&FhFinal="+FhFinal;
        }
        ...
        List<Map<String, Object>> ventasMol = (List<Map<String, Object>>) response.get("value");
